                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Wrap(
                            ...
                            spacing: 5,
                            children: <Widget>[
                              Helper.getPrice(widget.cart.product.price, context, style: Theme.of(context).textTheme.headlineMedium, zeroPlaceholder: '-'),
                              widget.cart.product.discountPrice > 0
                                  ? Helper.getPrice(widget.cart.product.discountPrice, context,
                                      style: Theme.of(context).textTheme.bodyLarge.merge(TextStyle(decoration: TextDecoration.lineThrough)))
                                  : SizedBox(height: 0),
                            ],
                          ),
