                      ...
                      children: <Widget>[
                                    ...
                                    label: Row(
                                      ...
                                      children: <Widget>[
                                        Text(_con.order.productOrders[0].product.market.rate,
                                            style: Theme.of(context).textTheme.displaySmall.merge(TextStyle(color: Theme.of(context).primaryColor))),
                                        Icon(
                                          Icons.star_border,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(S.of(context).how_would_you_rate_this_market_, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleMedium),
                              SizedBox(height: 10),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: Theme.of(context).textTheme.bodySmall.merge(TextStyle(fontSize: 14)),
                          ...
                          children: List.generate(_con.productsOfOrder.length, (index) {
                            return Container(
                              ...
                              child: Column(
                                ...
                                mainAxisSize: MainAxisSize.max,
                                children: <Widget>[
                                  Text(_con.productsOfOrder[index].name, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleMedium),
                                  SizedBox(height: 10),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
